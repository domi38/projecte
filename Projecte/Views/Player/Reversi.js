function ReversiCtrl($scope, $http) {
    //debugger;
    ...
    $scope.clickSquare = function (row, column) {
        ...
        if (this.makeMove(row, column)) {
            ...
            //Indicamos a quien pertenece el turno
            if (turnLetter == "X") {
                $scope.negre = false;
                $scope.blanc = true;
            } else {
            ...
            ++$scope.playerTurn;
            if ($scope.negre == false) {
                return $scope.negre;
            }
            if ($scope.blanc == false) {
                return $scope.blanc;
            }
        }
        else
    ...
    $scope.resetBoard = function () {
        ...
        //$scope.jugador = "Torn dels blancs";
    ...
    $scope.makeMove = function (row, col) {
        ...
        dirs.forEach(function (dir) {
            ...
            while (true) {
                ...
                if (oth[tRow][tCol] == "")
                    break;
                if (oth[tRow][tCol] == ours) {	// Cool, it is a good move and let's flip stuff.
